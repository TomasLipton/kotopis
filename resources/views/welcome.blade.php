...
<div class="modal opacity-0 pointer-events-none fixed w-full h-full top-0 left-0 flex items-center justify-center">
    ...
    <div class="modal-container fixed w-full h-full z-50 overflow-y-auto ">
        ...
        <div class="modal-content container mx-auto h-auto text-left p-4 mt-6">
...
{{--                <p class="text-2xl font-bold">Full Screen Modal!</p>--}}
            ...
            <div class="flex flex-wrap">
                <div class="w-full p-1 md:p-2">
                        <img alt="gallery" id="modal-img" class="block object-cover object-center rounded-lg hover:shadow-lg transition duration-300 ease-in-out"
                             src="#">
                </div>
            </div>
